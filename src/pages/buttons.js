          ...
          {({ baseFont }) => {
            return (
              <>
                ...
                <CSS>
                  background-color: #ef7d25; color: #fff; font-size: 1.4rem;
                  font-family: "Roboto", sans-serif; border-radius: 3px;
                  -webkit-border-radius: 3px; -moz-border-radius: 3px;
                  -ms-border-radius: 3px; -o-border-radius: 3px; text-transform:
                  uppercase; padding: 1.5rem 3rem; letter-spacing: 2px;
                ...
                <CSS>
                  ...
                  -webkit-border-radius: 3px; -moz-border-radius: 3px;
                  -o-border-radius: 3px; border-radius: 3px; transition: all
                  0.4s ease;
                </CSS>
                <p>:hover:before</p>
                <CSS>width: 100%;</CSS>
                ...
                <CSS>
                  ...
                  3px; padding: 1.5rem 3rem; letter-spacing: 2px; font-size:
                  1.4rem; font-family: "Roboto", sans-serif; text-transform:
                ...
                <CSS>
                  content: ""; position: absolute; top: 0; left: 0; width: 0;
                  bottom: 0; background: rgba(0, 0, 0, 0.2); transition: all
                  0.4s ease;
                </CSS>
                <p>:hover:before</p>
                <CSS>width: 100%;</CSS>
                ...
                <CSS>
                  ...
                  -moz-border-radius: 3px; -o-border-radius: 3px; border-radius:
                  3px; padding: 1.4rem 2.9rem; border: solid 1px #d1d1d1;
                  letter-spacing: 2px; font-size: 1.4rem; font-family: "Roboto",
