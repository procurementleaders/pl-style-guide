          ...
          {({ baseFont }) => {
            return (
              <>
                ...
                <pre>
                  background-color: #ef7d25; color: #fff;
                  <br />
                  font-size: 1.4rem;
                  <br />
                  ...
                  text-transform:
                  <br />
                  uppercase; padding: 1.5rem 3rem; <br />
                  letter-spacing: 2px;
                  <br />
...
:hover:before {
  width: 100%;
                ...
                <pre>
                  ...
                  <br />
                  -webkit-border-radius: 3px;
                  <br /> -moz-border-radius: 3px;
                  <br /> -o-border-radius: 3px;
                  <br /> border-radius: 3px;
                  <br /> padding: 1.4rem 2.9rem; <br />
                  border: solid 1px #d1d1d1; letter-spacing: 2px; font-size:
                  <br /> 1.4rem; font-family: <br />
                  "Roboto", sans-serif; text-transform:
                  <br /> uppercase; <br />
                  font-weight: 600;
